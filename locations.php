                    ...
                    <div class="col-md-8">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between py-2">
                                <a href="sub_location.php?sub_location=Epz">Epz Sublocation</a>
                                <span>1,200 Applicants</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between  py-2">
                                <a href="sub_location.php?sub_location=New Valley">New Valley Sublocation</a>
                                <span>800 Applicants</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between py-2">
                                <a href="sub_location.php?sub_location=Milimani">Milimani Sublocation</a>
                                <span>600 Applicants</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between py-2">
                                <a href="sub_location.php?sub_location=Kimalat">Kimalat Sublocation</a>
                                <span>500 Applicants</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between py-2">
                                <a href="sub_location.php?sub_location=Yukos">Yukos Sublocation</a>
