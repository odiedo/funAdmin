...
include('connection/location_summary.php');
?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <?php if (!empty($locations)): ?>
                                <?php foreach ($locations as $location): ?>
                                    <li class="list-group-item d-flex justify-content-between py-2">
                                        <a href="sub_location.php?location=<?php echo urlencode(strtolower(str_replace(' ', '_', $location['location']))); ?>">
                                            <?php echo htmlspecialchars($location['location']); ?> Location
                                        </a>
                                        <span><?php echo number_format($location['location_tot']); ?></span>
                                    </li>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <li class="list-group-item">No location data available.</li>
                            <?php endif; ?>
                        </ul>
                    </div>
                    <div class="col-md-4">
                        <h5 class="py-4">Summary for <?php echo htmlspecialchars($selectedWard); ?> Ward</h5>
                        <ul class="list-group mb-4">
                            <li class="list-group-item d-flex justify-content-between"><span><?php echo htmlspecialchars($selectedWard); ?> Total Applicants:</span> <span><?php echo number_format(array_sum(array_column($locations, 'applicants'))); ?></span></li>
